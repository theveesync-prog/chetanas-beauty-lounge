    ...
    <>
      ...
      <section className="pt-28 pb-12 bg-[#fdf8f5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-semibold text-[#5f1e42] mb-4">
            {cat.icon} {cat.label}
          </h1>
          <p className="text-[#8c7b72] text-lg max-w-xl mx-auto mb-8">
            {cat.tagline}
          </p>
          <ServiceSearch />
        </div>
      ...
      {/* Service Cards Grid with Sort */}
      <section className="py-14 bg-[#fdf8f5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ServiceGrid category={cat} />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#5f1e42]">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70 mb-8">
            Message us on WhatsApp and our team will help you choose the perfect
            treatment.
          </p>
          <a
