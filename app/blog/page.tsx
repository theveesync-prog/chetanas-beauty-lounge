    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <p className="section-label mb-4">From Our Experts</p>
          <h1
            className="font-display text-5xl sm:text-6xl lg:text-7xl font-semibold mb-5 leading-tight"
            style={{ color: "#5f1e42" }}
          >
            Beauty Tips &amp; Guides
          </h1>
      ...
      {/* ── Category Pills ─────────────────────────────────────── */}
      <section
        className="sticky top-16 z-40 border-y"
        style={{ backgroundColor: "white", borderColor: "rgba(95,30,66,0.08)" }}
      >
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <a
              ...
              className="group block rounded-3xl overflow-hidden shadow-sm border card-hover"
              style={{ borderColor: "rgba(95,30,66,0.08)", backgroundColor: "white" }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden" style={{ minHeight: "320px" }}>
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(95,30,66,0.25) 0%, transparent 60%)",
                    }}
                  />
                ...
                <div className="flex flex-col justify-center p-8 md:p-12 gap-5">
                  <div>
                    <h2
                      className="font-display text-3xl md:text-4xl font-semibold leading-snug mb-4"
                      style={{ color: "#1a0d0d" }}
                    >
                      {featured.title}
                    </h2>
                    <p className="text-base leading-relaxed" style={{ color: "#8c7b72" }}>
                      {featured.excerpt}
                    </p>
                  </div>
      ...
      <section
        className="py-14 px-4"
        style={{ backgroundColor: activeCategory === "all" ? "#f5ece4" : "#fdf8f5" }}
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {gridPosts.length === 0 ? (
            <div className="text-center py-16" style={{ color: "#8c7b72" }}>
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden" style={{ height: "220px" }}>
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to top, rgba(26,13,13,0.3) 0%, transparent 50%)",
                        }}
                      />
                      {/* Category pill */}
                      <span
                    ...
                    <div className="flex flex-col flex-1 p-6 gap-3">
                      ...
                      <div
                        ...
                        style={{ borderColor: "rgba(95,30,66,0.08)" }}
                      >
                        <div className="flex items-center gap-2">
                          <span
