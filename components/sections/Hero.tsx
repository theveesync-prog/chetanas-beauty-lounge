...
const HERO_IMAGE =
  "https://images.unsplash.com/photo-1487412947147-5cebf100d293?w=900&q=85&auto=format&fit=crop&crop=faces";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* ── Left: Text Content ─────────────────────────────── */}
          <div className="relative z-10 flex flex-col justify-between px-8 sm:px-12 lg:px-16 py-12 lg:py-16 lg:w-[45%]">

            {/* Main content block — tag, heading, subtitle, CTA */}
            <div>
              {/* Tag */}
              ...
              {/* H1 — large display serif to match reference */}
              <h1
            ...
            {/* Social Proof — anchored to bottom via justify-between */}
            <div className="hero-reveal reveal reveal-delay-4 flex flex-wrap items-center gap-3 pt-8">
              ...
              {/* Vertical divider */}
              <span className="w-px h-5 bg-[#ccc]" aria-hidden="true" />

              {/* CIDESCO certified — inline, no pill */}
          ...
          {/* ── Right: Image ───────────────────────────────────── */}
          {/* Desktop — portrait image with face toward left edge for visual bleed effect */}
          <div className="hidden lg:block lg:w-[55%] relative">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={HERO_IMAGE}
              alt="Client at Chetana's Beauty Lounge Mangaluru"
